...
internal class EffectOfNumberOfIterationsOnSolutionParametersFiller : ISpecificParametersFiller
{
    private readonly IIntValueFiller _intValueFiller;

    public EffectOfNumberOfIterationsOnSolutionParametersFiller(IIntValueFiller intValueFiller)
    {
