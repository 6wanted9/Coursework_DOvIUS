...
public class EffectOfMaxWeightOnSolutionTaskRunner : ISpecificTaskRunner
{
    ...
    public EffectOfMaxWeightOnSolutionTaskRunner(
    ...
    {
        var maxWeights = Enumerable.Range(1, MaxWeightsAmount).Select(order => order * StepBetweenMaxWeights).ToList();
        ...
        foreach (var maxWeight in maxWeights)
        {
            ...
            table.AddRow(maxWeight, greedyAverageTargetFunctionValue, localSearchAverageTargetFunctionValue);
        }
